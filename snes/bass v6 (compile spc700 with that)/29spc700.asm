...
.doEffectEchoOn:	//243
	jsr readChannelByte		// read the prearranged bitwise OR mask
	ora {D_EON}				// bitwise OR with mask to activate echo
	jsr effectEchoFinish
	jmp .readLoop

.doEffectEchoOff:	//244
	jsr readChannelByte		// read the prearranged bitwise AND mask (ex: 11110111)
	and {D_EON}				// bitwise AND with mask to deactivate echo
	jsr effectEchoFinish
	jmp .readLoop
...
DSPInitData:
	...
	db {DSP_ESA}  ,$29                      // 29~ ECHO BUFFER START
	db {DSP_EDL}  ,$29                      // 29~ ECHO BUFFER LENGTH
	db {DSP_EFB}  ,$29                      // 29~ ECHO FEEDBACK
	db {DSP_C0}	  ,$29						// 29~ FIR C0
	db {DSP_C1}	  ,$29                      // 29~ FIR C1
	db {DSP_C2}	  ,$29                      // 29~ FIR C2
	db {DSP_C3}	  ,$29                      // 29~ FIR C3
	db {DSP_C4}	  ,$29                      // 29~ FIR C4
	db {DSP_C5}	  ,$29                      // 29~ FIR C5
	db {DSP_C6}	  ,$29                      // 29~ FIR C6
	db {DSP_C7}	  ,$29                      // 29~ FIR C7
	db {DSP_EON}  ,0						//echo disabled
	db {DSP_EVOLL},$29                      // 29~ EVOL L
	db {DSP_EVOLR},$29                      // 29~ EVOL R
